      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-950 px-4">
        <div className="max-w-xl w-full text-center space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-left">
            {[
              { icon: Bot, label: "Your AI Team", desc: "38 specialists that handle marketing, finance, writing, strategy, coding, and more — like having a team on call 24/7" },
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-950 px-4">
        <div className="max-w-2xl w-full text-center space-y-8">
          ...
          <p className="text-xs text-zinc-400">
            You can access all 38 agents anytime from the sidebar.
          </p>
      ...
      <div className="max-w-xl w-full text-center space-y-8">
        ...
        <div className="space-y-3 text-left">
          {[
            ...
            { icon: Sparkles, label: "Browse all agents", desc: "Click \"Discover\" to see all 38 AI specialists organized by category. Try a few — each one is trained for different tasks." },
