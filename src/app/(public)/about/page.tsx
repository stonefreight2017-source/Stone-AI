    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <main id="main-content" className="px-6 py-12 max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert prose-zinc max-w-none space-y-8 text-sm text-zinc-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-white">38 AI Specialist Agents</h2>
            <p>
              Stone AI provides 38 purpose-built AI agents spanning every major business department —
