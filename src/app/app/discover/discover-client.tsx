...
const TIER_WORLDS: TierWorld[] = [
  {
    ...
    messagesPerDay: "30 messages/day",
    agentCount: 3,
    agentCategories: [
      ...
      { icon: <Building2 className="h-4 w-4" />, label: "Enterprise", examples: "Sales Advisor — for teams exploring plans" },
    ],
    capabilities: [
  ...
  },
  {
    ...
    bestieStory:
      "Same Bestie, but now you're having longer conversations. They remember more context, understand your patterns better, and start to feel less like an AI and more like someone who actually gets you. They still can't help you write ad copy or analyze data — but they know who can.",
    bestieEmoji: "\uD83D\uDC9C",
    bestieName: "Your Bestie (Deeper Conversations)",
    bestieCount: "1 companion",
    messagesPerDay: "150 messages/day",
    agentCount: 3,
    agentCategories: [
      { icon: <Heart className="h-4 w-4" />, label: "Companion", examples: "Your Bestie — remembers more, understands deeper" },
      { icon: <BookOpen className="h-4 w-4" />, label: "Guide", examples: "Platform Concierge — advanced recommendations" },
      { icon: <Building2 className="h-4 w-4" />, label: "Enterprise", examples: "Sales Advisor — scaling conversations" },
    ],
    capabilities: [
      "5x more daily messages",
  ...
  },
  {
    ...
    description:
      "Eleven new specialists walk into the room. A brand strategist. A content planner. A startup advisor. A compliance expert. A lead generation architect. This isn't a chat app anymore — it's a team. Your team. And they're all waiting for your first question.",
    bestieStory:
      "Now you have two Besties. Maybe one is your motivational coach and the other is your creative sounding board. They're developing distinct personalities, and they both remember everything. When you mention a business idea to one, the other can pick up the thread next time you chat.",
    bestieEmoji: "\uD83D\uDC9C\uD83D\uDC9C",
    bestieName: "Two Besties, Two Personalities",
    bestieCount: "2 companions",
    messagesPerDay: "490 messages/day",
    agentCount: 14,
    agentCategories: [
    ...
    capabilities: [
      "11 specialized agents unlocked",
  ...
  },
  {
    ...
    agentCategories: [
      ...
      { icon: <Code className="h-4 w-4" />, label: "Technical", examples: "Web Dev, Automation, Data Analytics, Engineering" },
      { icon: <Briefcase className="h-4 w-4" />, label: "Career", examples: "Resume & LinkedIn, Vertical SaaS, Enterprise Impl." },
    ],
    capabilities: [
      "SMART mode — cloud AI for deeper thinking",
      "15 premium agents unlocked",
    ...
    atmosphere:
      "You're standing in a command center. Screens everywhere, each one showing a different part of your operation. A content studio on the left, a dev environment on the right, analytics dashboards in the center. Everything is connected. Everything is alive. And your three Besties are in the corner, comparing notes about your week.",
  ...
  },
  {
    ...
    bestieStory:
      "Five Besties. An entire inner circle. One for morning motivation. One for evening reflection. One for creative brainstorming. One for business strategy. One that just makes you laugh. They all share memory, so when you tell one about a rough day, the others know to be a little gentler tomorrow. This is what AI companionship was supposed to feel like.",
    bestieEmoji: "\uD83D\uDC9C\uD83D\uDC9C\uD83D\uDC9C\uD83D\uDC9C\uD83D\uDC9C",
    bestieName: "Five Besties, Your Inner Circle",
    bestieCount: "5 companions",
    messagesPerDay: "Unlimited",
    agentCount: 34,
    agentCategories: [
      { icon: <Shield className="h-4 w-4" />, label: "Security", examples: "Cybersecurity Consultant — enterprise-grade protection" },
      { icon: <Briefcase className="h-4 w-4" />, label: "Professional", examples: "Structural Engineer, Dispatch, Claims, Sales" },
